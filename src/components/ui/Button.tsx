...
export const Button: React.FC<ButtonProps> = ({
 ...
 const variantStyles = {
  ...
  // FIXED: Light bg + dark text in light mode, Dark bg + light text in dark mode
  secondary: 'bg-slate-100 text-slate-800 hover:bg-slate-200 focus:ring-slate-400 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700',
